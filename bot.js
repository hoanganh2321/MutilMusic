    ...
    if (command === "play") {
        ...
        if (loadType === 'playlist') {
            ...
            .setAuthor({
                ...
                .setColor('#14bdff')
                .setFooter({ text: 'Sử dụng lệnh hàng đợi để biết thêm thông tin' });
        ...
        if (!loopOption) return message.channel.send("Vui lòng cung cấp tùy chọn vòng lặp: **hàng chờ**, **theo dõi**, or **none**.");
        ...
        .setDescription('**Hãy hoạt động trở lại! Hãy để nhịp nhạc đang cuộn lên..**')
        .setColor('#2b71ec');
        message.reply({ embeds: [embed] });
